:site-date: 21-12-2017
:site-title: How-to create your own Certificate Authority (or the better way to get working snake oil certificates for internal use).
:site-author: sid
:site-tags: Linux, PC-Krams, RSA, Certificates
